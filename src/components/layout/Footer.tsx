    ...
    <footer className="border-t border-border/50 bg-card/50">
      <div className="container py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="md:col-span-1">
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              Plateforme d'analyse immobiliere pour investisseurs locatifs, avec methode explicite et parcours public
              structure.
            </p>
          </div>
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-3 border-t border-border/30 pt-6 sm:flex-row">
          <p className="text-xs text-muted-foreground">(c) {new Date().getFullYear()} {SITE_NAME}. Tous droits reserves.</p>
          <p className="text-xs text-muted-foreground">Version V2 - Aide a la decision, pas conseil financier.</p>
        </div>
      </div>
    </footer>
  );
