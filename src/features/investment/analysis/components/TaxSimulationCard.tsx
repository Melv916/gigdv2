            ...
            {props.paywallRequired ? (
              <div className="mt-4 rounded-xl border border-dashed border-primary/40 bg-primary/5 p-4">
                ...
                <p className="mt-2 text-xs text-muted-foreground">
                  Le plan Free conserve la lecture economique brute. Passez au plan superieur pour debloquer
                  les regimes fiscaux, le cash-flow apres impot et le comparatif.
                </p>
      ...
      {!props.paywallRequired && props.primaryAnalysis && (
        <div className="mt-6 space-y-4">
          <div className="grid gap-3 md:grid-cols-5">
            ...
            <div className="analysis-cockpit-subcard p-4">
              <p className="analysis-label">Cash-flow apres impot</p>
              ...
              <table className="w-full min-w-[720px] text-sm">
                <thead>
                  <tr className="border-b border-border/40 text-left text-xs uppercase tracking-wide text-muted-foreground">
                    ...
                    <th className="pb-2 pr-4">CF avant impot</th>
                    <th className="pb-2 pr-4">Impot</th>
                    <th className="pb-2 pr-4">CF apres impot</th>
